        ...
        [
            ...
            .custom(
                ...
                didMigrate: { context in
                    ...
                    for episode in episodes {
                        episode.symptomsStorage = StringListStorage.migrateLegacyStorage(episode.symptomsStorage)
                        episode.triggersStorage = StringListStorage.migrateLegacyStorage(episode.triggersStorage)
                    }
